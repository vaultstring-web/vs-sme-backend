...
router.post('/applications/:id/documents/upload', authenticate_1.authenticate, upload_1.uploadMiddleware.single('file'), applications_controller_1.validateDocumentTypeBody, applications_controller_1.uploadDocumentFile);
